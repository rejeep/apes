...
/**
 * <p>
 * This class handles all controller actions. All controllers should
 * extend ApplicationController, that in turn extend this class. This
 * means that all controllers will handle events the same way.
 * </p>
 * <h4>Usage</h4>
 * <p>
 * If you want to connect an event to a <code>Component</code>, Say
 * for example a <code>JButton</code>, you add a listener as usual:
 * </p>
 * 
 * <pre>
 ...
 * 
 * <p>
 * Note that the event should <strong>always</strong> go to the
 * controller.
 * </p>
 * <p>
 ...
 * 
 * <p>
 * The name of the method that will be called in the controller, that
 * was connected to the component, is the one with the same name as
 * the component name. This however, is only true, if there's a method
 * in the controller with that name, taking no arguments. So for the
 * above example the <code>action</code> method in the
 * <code>controller</code> controller will be called when
 * <code>button</code> is clicked.
 * </p>
 * <p>
 * However. If there is no method named action in the controller. A
 ...
 * </p>
 * <p>
 * Before a method is called, {@link
 * ApplicationController#beforeFilter beforeFilter} is called. And
 * after the method is called, {@link
 * ApplicationController#afterFilter afterFilter} is called. However.
 * The action is only called if there's no exception thrown in the
 * before filter. This can be used to not call an action on some
 * condition in the before filter.
 * </p>
 * <p>
 * Two variables are by default available in the controllers.
 * <ul>
 * <li>event - Is the event that was fired.</li>
 * <li>name - Is the name of the component that the event was fired
 * on.</li>
 * </ul>
 * </p>
 ...
 * </p>
 * <p>
 * If you done that and it still doesn't work, make sure that this
 ...
 * </p>
 * <p>
 * One more thing to check is if your controller is created or not.
 * Because if you send null to <code>addActionListener</code>, you
