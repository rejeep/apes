...
/**
 * This class contains stuff common to all controllers. All controllers, other
 * than {@link ActionController ActionController}, should extend this class.
 * 
...
public abstract class ApplicationController extends ActionController
{
   ...
   * it in your controllers to implement a special behavior in these cases.
   */
   ...
   * 
   * @exception Exception If an exception is thrown. If an exception is thrown.
   *              The action method will never be called.
   */
